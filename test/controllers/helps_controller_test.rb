...
class HelpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create help" do
    assert_difference('Help.count') do
      post helps_url, params: { help: { contact: @help.contact, description: @help.description } }
    end
  ...
  test "should update help" do
    patch help_url(@help), params: { help: { contact: @help.contact, description: @help.description } }
